---
title: Unsolicited abstraction of modern times
description: An abstraction and reflection on the last era
heroImage: ../../assets/art/unsolicited/N83.png
pubDate: 2022-01-14
...
![](https://p4.wallpaperbetter.com/wallpaper/1012/225/206/technology-vintage-retro-computers-computer-retrowave-hd-wallpaper-preview.jpg)
...
![](https://upload.wikimedia.org/wikipedia/commons/1/16/IMac_G3_color_carousel.gif) [CC Wikipedia]

#### Color palettes

The "Modern Computing" color palette pays homage to the iMac design and its legacy.

<div id="p5-target" style="width: 100%; min-height: 400px;"></div>
...
![](../../assets/art/unsolicited/N96.png)

Some of my favourite editions:

<div class="portfolio-feed layout-mosaic">
  <article class="project">
    <a href="https://www.fxhash.xyz/gentk/691768" class="project-link">
      <div class="project-thumbnail">
        <img src="../../assets/art/unsolicited/N1.png" alt="White, black, and red shoe sole">
      </div>        
      <header class="project-header">
        <h2 class="project-title">#1</h2>
      </header>
    </a>
  </article>
  <article class="project">
    <a href="https://www.fxhash.xyz/gentk/691769" class="project-link">
      <div class="project-thumbnail">
        <img src="../../assets/art/unsolicited/N2.png" alt="White, black, and red shoe sole">
      </div>        
      <header class="project-header">
        <h2 class="project-title">#2</h2>
      </header>
    </a>
  </article>
  <article class="project">
    <a href="https://www.fxhash.xyz/gentk/691792" class="project-link">
      <div class="project-thumbnail">
        <img src="../../assets/art/unsolicited/N13.png" alt="White, black, and red shoe sole">
      </div>        
      <header class="project-header">
        <h2 class="project-title">#13</h2>
      </header>
    </a>
  </article>

  <article class="project">
    <a href="https://www.fxhash.xyz/gentk/691810" class="project-link">
      <div class="project-thumbnail">
        <img src="../../assets/art/unsolicited/N20.png" alt="White, black, and red shoe sole">
      </div>        
      <header class="project-header">
        <h2 class="project-title">#20</h2>
      </header>
    </a>
  </article>

  <article class="project">
    <a href="https://www.fxhash.xyz/gentk/692363" class="project-link">
      <div class="project-thumbnail">
        <img src="../../assets/art/unsolicited/N67.png" alt="White, black, and red shoe sole">
      </div>        
      <header class="project-header">
        <h2 class="project-title">#67</h2>
      </header>
    </a>
  </article>

  <article class="project">
    <a href="https://www.fxhash.xyz/gentk/692457" class="project-link">
      <div class="project-thumbnail">
        <img src="../../assets/art/unsolicited/N83.png" alt="White, black, and red shoe sole">
      </div>        
      <header class="project-header">
        <h2 class="project-title">#83</h2>
      </header>
    </a>
  </article>

  <article class="project">
    <a href="https://www.fxhash.xyz/gentk/692479" class="project-link">
      <div class="project-thumbnail">
        <img src="../../assets/art/unsolicited/N97.png" alt="White, black, and red shoe sole">
      </div>        
      <header class="project-header">
        <h2 class="project-title">#97</h2>
      </header>
    </a>
  </article>

  <article class="project">
    <a href="https://www.fxhash.xyz/gentk/692530" class="project-link">
      <div class="project-thumbnail">
        <img src="../../assets/art/unsolicited/N141.png" alt="White, black, and red shoe sole">
      </div>        
      <header class="project-header">
        <h2 class="project-title">#141</h2>
      </header>
    </a>
  </article>
...
# [Unsolicited abstraction of modern times on FxHash](https://www.fxhash.xyz/generative/12849)


<script>

const Palettes = [
	"472c8b-37A959-ee3741-0095b6-f05225",
	"2b2d42-8d99ae-1e7ca4-ef233c-d80032",
	"0d3b66-f0c62d-ee964b-f95738",
	"8ecae6-219ebc-023047-ffb703-fb8500",
	"2b2d42-8d99ae-2EC4B6-ef233c-f8961e"
	]
const names = ["Modern Computing","Industrial","TextBook","Glass","Broken Heart"]
const padding = 14

</script>

<script src="https://cdnjs.cloudflare.com/ajax/libs/p5.js/1.4.0/p5.js"></script>
<script src="/js/p5.paletteViewer.js"></script>
